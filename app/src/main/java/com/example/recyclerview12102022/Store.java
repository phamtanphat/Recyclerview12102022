...
public class Store {
    ...
    public static List<Store> getMock() {
        return new ArrayList<>(Arrays.asList(
                new Store(R.drawable.bep_ba_muoi, 21600000, 79200000, "Bếp Bà Muối - Ăn Vặt Online", "606/52 Đường 3 Tháng 2, P. 14, Quận 10, TP. HCM", new ArrayList<>(Arrays.asList(ServiceType.SHOP_ONLINE, ServiceType.BIRTH_DAY)), "", 0),
                new Store(R.drawable.bep_ba_muoi, 21600000, 79200000, "Bếp Bà Muối - Ăn Vặt Online", "606/52 Đường 3 Tháng 2, P. 14, Quận 10, TP. HCM", new ArrayList<>(Arrays.asList(ServiceType.SHOP_ONLINE, ServiceType.FAMILY)), "Cả ngày - Giảm 15%", 10),
                ...
                new Store(R.drawable.katinat, 21600000, 79200000, "Katinat - Cộng Hoà", "20 Cộng Hoà, P. 4, Tân Bình, TP. HCM", new ArrayList<>(Arrays.asList(ServiceType.BIRTH_DAY, ServiceType.GROUP)), "Cả ngày - Giảm 15%", 1),
