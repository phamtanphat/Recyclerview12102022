...
public class Store {
    ...
    public static List<Store> getMock() {
        return new ArrayList<>(Arrays.asList(
                new Store(R.drawable.bep_ba_muoi, 65200000, 65200001, "Bếp Bà Muối - Ăn Vặt Online", "606/52 Đường 3 Tháng 2, P. 14, Quận 10, TP. HCM", new ArrayList<>(Arrays.asList(ServiceType.SHOP_ONLINE, ServiceType.BIRTH_DAY)), "", 0),
